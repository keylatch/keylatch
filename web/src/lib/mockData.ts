...
const mockDoctorResponse: DoctorResponse = {
  ...
  checks: [
    ...
    { name: 'guard_hook_installed', section: 'security', ok: true, detail: 'Claude Code guard hook installed', tags: ['security'] },
    { name: 'op_cli_available', section: 'backends', ok: false, detail: '1Password CLI (op) not detected', fix: 'brew install 1password-cli', tags: ['backends'] },
    { name: 'bw_cli_available', section: 'backends', ok: false, detail: 'Bitwarden CLI (bw) not detected', fix: 'brew install bitwarden-cli', tags: ['backends'] },
  ],
  sections: [
    ...
    { name: 'security', ok: true, has_warn: false, check_count: 2 },
    { name: 'backends', ok: false, has_warn: false, check_count: 2 },
  ],
  version: '0.9.0-demo',
